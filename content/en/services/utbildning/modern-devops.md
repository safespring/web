...
<form id="up-form" name="form_9549ue770a5b7152b4b9796393b0943084e71" action="https://power.upsales.com/api/external/formSubmit" method="POST">
  ...
  <div class="form">{{< fa-icon class="fas fa-user-tie" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.name" required="" aria-label="Your name" placeholder="Your name"></div>
  <div class="form">{{< fa-icon class="fas fa-mobile-alt" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.cellPhone" required="" aria-label="Your cell phone" placeholder="Your cell phone"></div>
  <div class="form">{{< fa-icon class="fas fa-envelope" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="email" id="up-email-input" autocomplete="off" name="Contact.email" required="required" aria-label="Your E-mail" placeholder="Your E-mail"></div>
  ...
  <br>
	<p>By submitting this form you agree to our <a href="{{% relref "/compliance/privacy_policy_web_recruitment.md" %}}" target="_blank">terms and conditions</a> (English).</p>
