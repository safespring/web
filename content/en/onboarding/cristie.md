---
title: "Safespring Onboarding Instructions for Cristie"
date: 2024-09-23T13:05:26+02:00
draft: false
intro: "Follow these steps to set up and manage new projects in Safespring’s S3 service. Using the correct project naming and credential handling ensures smooth billing and easy collaboration with resellers."
background: ""
...
<form id="up-form" name="form_9549u6488cf25775f4e62b6d09de546b45f5f" action="https://power.upsales.com/api/external/formSubmit" method="POST">
    ...
    <div class="form-field">
        ...
        <label for="project">{{< fa-icon class="fas fa-input-text" >}}&nbsp;&nbsp;&nbsp;Project name (Eg. customer1.reseller1.com)</label>
    </div>
{{% accordion title="How to name a project" %}}
Cristie should name their projects with the following nomenclature:

`customer1.reseller1.com`
`customer2.reseller1.com`
`customer3.reseller2.com`

This way, we can maintain a good overview of which costs that should go to which reseller in the billing files.
{{% /accordion %}}
<h2>Acceptence</h2>
