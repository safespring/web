...
These different bases create a legal sticking point that’s not entirely easy to sort out. For more information on this topic, we recommend reading [Safespring’s white paper on Schrems II]({{% relref "/whitepaper/schrems-ii.md" %}}), which explains the latest developments in connection with the annulment of Privacy Shield by the European Court of Justice. In recent years, Privacy Shield has been the agreement that US cloud services have relied on within the EU.
