...
{{< horisontal-card
    ...
    link="/containers/"
    linktext="Discover Kubernetes Engine"
>}}
...
{{< horisontal-card
    ...
    text="Safespring Kubernetes Engine lets you test-drive Gateway API and Cilium in an environment with Talos, observability, and storage already prepared. Perfect for piloting your Ingress-Nginx migration before rolling it into production."
    link="/containers/"
    linktext="Discover Kubernetes Engine"
>}}
