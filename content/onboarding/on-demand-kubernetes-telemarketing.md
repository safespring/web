...
{{< ingress >}}
Du behöver inte kunna Kubernetes, containrar eller tekniska plattformar för att boka möten om tjänsten. Din uppgift är att förstå om kunden har ett möjligt behov, särskilt om de bryr sig om digital suveränitet, och få till ett första relevant möte med rätt person hos Safespring.
{{< /ingress >}}

{{% note "Viktigast att komma ihåg" %}}
Försök inte förklara tekniken i detalj. Håll dig till enkla ord som drift, säkerhet, kontroll, dataplacering, modernisering och digital suveränitet. Om kunden vill gå djupare är det specialistens jobb, inte ditt.
...
{{% accordion title="Vad är en container?" id="ord-container" %}}
En container är ett sätt att paketera en applikation så att den blir enklare att starta, flytta och köra på ett liknande sätt i olika miljöer.

En enkel liknelse är att en container är som en standardiserad låda runt en applikation. Lådan gör det lättare att hantera applikationen på ett ordnat sätt.
{{% /accordion %}}

{{% accordion title="Vad är Kubernetes?" id="ord-kubernetes" %}}
Kubernetes är ett system för att hantera många containrar. Det hjälper företag att starta, stoppa, skala och hålla igång applikationer.

Du kan tänka på det som ett kontrollsystem för moderna applikationer. Om containern är själva lådan runt en applikation, så är Kubernetes systemet som håller ordning på alla lådor.
{{% /accordion %}}

{{% accordion title="Vad menar vi med plattform?" id="ord-plattform" %}}
När vi säger plattform menar vi den tekniska miljö där applikationer körs och hanteras. Det handlar alltså om grunden som applikationerna står på.

I den här tjänsten betyder det i praktiken en lösning där kunder kan köra moderna applikationer på ett mer strukturerat, säkert och kontrollerat sätt.
{{% /accordion %}}

{{% accordion title="Vad betyder digital suveränitet?" id="ord-digital-suveranitet" %}}
Digital suveränitet betyder i enkel form att en organisation vill ha större kontroll över var data finns, vilka lagar och regler som gäller, och hur beroende man är av utländska molnleverantörer.
...
{{< contact-small title="Tekniskt ledarskap" name="Head of Engineering" email="om utvecklingsteam eller applikationsdrift påverkas" >}}
{{< contact-small title="Plattform och drift" name="Plattformsansvarig" email="om frågan rör hur applikationer körs och hanteras" >}}
{{< contact-small title="Automation och drift" name="DevOps-ansvarig" email="om teamet arbetar med containrar, Kubernetes eller CI/CD" >}}
{{< contact-small title="Infrastruktur" name="Infrastrukturchef" email="om frågan rör driftmiljö, kapacitet eller teknisk grund" >}}
{{< contact-small title="Övergripande IT-ansvar" name="IT-chef" email="om frågan rör IT-prioriteringar, ansvar eller leverantörsval" >}}
...
Målet är inte att sälja tjänsten i telefon.
