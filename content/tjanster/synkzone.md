...
Med s.k. **zero knowledge** kan varken vi som operatör av tjänsten eller någon annan som kommer åt er data läsa era filer. Detta ger ett skydd som är långt mycket starkare än vad som är vanligt både på traditionella filservrar och i andra molntjänster.
...
## FAKTA
- Alla filer lagras (krypterat) på er egen server.
