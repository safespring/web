...
{{< icon-block icon="fa-kit fa-safespring-icon" text="Bli kjent med oss" link="/om-safespring/" color="#3C9BCD">}}
{{< icon-block icon="fa-solid fa-lightbulb-on" text="Les løsningsbeskrivelser" link="/losningsfaktablad/" color="#3C9BCD">}}
