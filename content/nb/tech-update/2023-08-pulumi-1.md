...
Etter å ha konfigurert Pulumi med OpenStack-malen, ser vi en fil som heter `__main__.py` i Pulumi-arbeidskatalogen. Dette er en eksempelfil som er opprettet av malprosessen.```python
...
+--------------------------------------+------------------+----------------------------------------------------------------------------+
```
Så velger vi å endre `__main__.py`-filen slik:```python
"""An OpenStack Python Pulumi program"""
...
deretter anvende den grafen mot OpenStack API med Pulumi.```shell
(oscli) ubuntu@demo-jumphost:~/pulumi$
...
Hvis vi bryr oss om navnet på instansen, kan vi bare legge det til i Pulumi-programmet slik:```python
"""An OpenStack Python Pulumi program"""
...
La oss legge til denne koden i Pulumi Python-programmet:```python
"""An OpenStack Python Pulumi program"""
