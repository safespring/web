...
<form id="up-form" name="form_9549u6488cf25775f4e62b6d09de546b45f5f" action="https://power.upsales.com/api/external/formSubmit" method="POST">
    ...
    <div class="form-field">
        ...
        <label for="eppn">{{< fa-icon class="fas fa-input-text" >}}&nbsp;&nbsp;&nbsp;EPPN (for tilkobling til NREN)</label>
    </div>
    ...
    <div class="form-field">
        ...
        <label for="site">{{< fa-icon class="fas fa-cloud-check" >}}&nbsp;&nbsp;&nbsp;Velg sted</label>{{< fa-icon class="fas fa-angle-down selection-icon" >}}
    </div>
    <div class="form-field">
        <input type="text" id="project" name="Extra.1683706799384" required placeholder="">
        <label for="project">{{< fa-icon class="fas fa-input-text" >}}&nbsp;&nbsp;&nbsp;Prosjektnavn (f.eks. infra.domain.com)</label>
    </div>
    <div class="form-field">
        ...
        <label for="billing">{{< fa-icon class="fas fa-envelope-open-dollar" >}}&nbsp;&nbsp;&nbsp;Fakturaadresse (e-post)</label>
    </div>
    <div class="form-field">
        <input maxlength="512" type="text" id="ip" name="Extra.1683706829902" required>
        <label for="ip">{{< fa-icon class="fas fa-input-numeric" >}}&nbsp;&nbsp;&nbsp;IP-adresse på hvitliste for API-tilgang</label>
    </div>
