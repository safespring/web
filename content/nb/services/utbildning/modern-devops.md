...
<form id="up-form" name="form_9549ue770a5b7152b4b9796393b0943084e71" action="https://power.upsales.com/api/external/formSubmit" method="POST">
  ...
  <div class="form">{{< fa-icon class="fas fa-user-tie" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.name" required="" aria-label="Ditt navn" placeholder="Ditt navn"></div>
  ...
  <br>
	<p>Ved å sende inn dette skjemaet godtar du våre <a href="{{% relref "/compliance/privacy_policy_web_recruitment.md" %}}" target="_blank">vilkår og betingelser</a> (engelsk).</p>
