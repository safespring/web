...
<form id="up-form" name="form_9549ue770a5b7152b4b9796393b0943084e71" action="https://power.upsales.com/api/external/formSubmit" method="POST">
  ...
  <div class="form">{{< fa-icon class="fas fa-mobile-alt" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.cellPhone" required="" aria-label="Ditt mobilnummer" placeholder="Ditt mobilnummer"></div>
  <div class="form">{{< fa-icon class="fas fa-envelope" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="email" id="up-email-input" autocomplete="off" name="Contact.email" required="required" aria-label="Din e-post" placeholder="Din e-post"></div>
