...
Disse ulike utgangspunktene skaper en juridisk floke som ikke er helt enkel å løse. For mer informasjon om dette anbefaler vi å lese [Safesprings hvitbok om Schrems II]({{% relref "/whitepaper/schrems-ii.md" %}}), som forklarer siste utvikling i forbindelse med at Privacy Shield ble opphevet av EU-domstolen. De siste årene har Privacy Shield vært avtalen som amerikanske skytjenester har støttet seg på innen EU.
