...
megamenu: "yes"
aliases:
  - /tjenester/safespring-s3-skalerbar-og-hojtydende-objektlagring/
  - /da/storage/
...
Udnyt Safespring Storage til at lagre store datasæt, der kræves til analyse- og machine learning-applikationer. Læs mere om, hvordan [SciLifeLab bruger Safespring til forskning inden for livsvidenskab]({{% relref "/services/case/scilifelab.md" %}}).
...
{{% custom-card image="/img/card/safespring-fredric.webp" cardtitle="Kontakt os i dag" alt="Kontakt Safespring" %}}
