...
<form id="up-form" name="form_9549ue770a5b7152b4b9796393b0943084e71" action="https://power.upsales.com/api/external/formSubmit" method="POST">
  <div class="form">{{< fa-icon class="fas fa-briefcase" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" id="up-client-name-input" name="Client.name" required="" aria-label="Organisation" placeholder="Organisation"></div>
  <div class="form">{{< fa-icon class="fas fa-user-tie" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.name" required="" aria-label="Dit navn" placeholder="Dit navn"></div>
  <div class="form">{{< fa-icon class="fas fa-mobile-alt" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="text" name="Contact.cellPhone" required="" aria-label="Dit mobilnummer" placeholder="Dit mobilnummer"></div>
  <div class="form">{{< fa-icon class="fas fa-envelope" >}}&nbsp;&nbsp;&nbsp;<input maxlength="512" type="email" id="up-email-input" autocomplete="off" name="Contact.email" required="required" aria-label="Din e-mail" placeholder="Din e-mail"></div>
  ...
  <br>
	<p>Ved at indsende denne formular accepterer du vores <a href="{{% relref "/compliance/privacy_policy_web_recruitment.md" %}}" target="_blank">vilkår og betingelser</a> (engelsk).</p>
