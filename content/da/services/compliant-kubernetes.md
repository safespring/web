...
{{% horisontal-card image="/img/graphics/safespring-image.svg" linkref="/services/compute.md" linktext="Læs mere" cardtitle="Safespring Compute: Fundamentet for Welkin" text="Vores infrastrukturtjeneste drives i state-of-the-art datacentre inden for EU, beskyttet mod love som CLOUD Act eller FISA 702." %}}
