---
ai: true
title: "Safespring onboarding-vejledning for SciLifeLab"
date: 2024-09-23T13:05:26+02:00
draft: false
intro: "Følg disse trin for at oprette og administrere nye projekter i Safespring. Brug af korrekt projektnavngivning og håndtering af adgangsoplysninger sikrer korrekt kvote og adgang."
background: ""
...
<form id="up-form" name="form_9549u6488cf25775f4e62b6d09de546b45f5f" action="https://power.upsales.com/api/external/formSubmit" method="POST">
    ...
    <div class="form-field">
        ...
        <label for="project">{{< fa-icon class="fas fa-input-text" >}}&nbsp;&nbsp;&nbsp;Projektnavn (F.eks. project.scilifelab.se)</label>
    </div>
        <div class="form-field">
...
<h2>Accept</h2>
    ...
    <div class="inputGroup">
        ...
        Generelle vilkår og betingelser <a class="label-link" href="/compliance/general_terms_and_conditions/" target="_blank" rel="noopener noreferrer" aria-label="Åbn generelle vilkår og betingelser" title="Åbn generelle vilkår og betingelser">{{< fa-icon class="fa-solid fa-arrow-up-right-from-square" >}}</a>
    </label>
    </div>
    <!-- REQUIRED FIELDS -->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    checkBtn.addEventListener("click", function (event) {
        ...
        if (!checked) {
            ...
            alert("Du skal acceptere vores vilkår og betingelser");
        }
    });
});
</script>
