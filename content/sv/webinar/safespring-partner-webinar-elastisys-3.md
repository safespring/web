...
{{< custom-card image="/img/graphics/compliant-kubernetes-on-safespring.svg" text="Kör Kubernetes som en tjänst på nordisk infrastruktur. Läs hur Elastisys bygger Welkin på Safespring Compute." cardtitle="Welkin på Safespring Compute" linktext="Läs mer" linkref="/services/case/elastisys.md" >}}{{< /custom-card >}}
