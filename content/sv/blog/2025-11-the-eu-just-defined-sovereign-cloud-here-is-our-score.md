---
ai: true
title: "EU har precis definierat det suveräna molnet, här är vårt resultat"
date: 2025-11-06
intro: "Cloud Sovereignty Framework är nu riktmärket för gradering av europeiska molntjänster. Det ställer hårda krav på ägande, kontroll, lagstiftning och infrastruktur. Här är vad det innebär och hur Safespring mäter sig."
draft: false
tags: ["English"]
showthedate: true
...
Inspirerad av initiativ från Frankrike[^1], Tyskland[^2] och europeiska regelverk[^3], liksom internationell praxis inom exportkontroller, resiliens i leveranskedjor och säkerhetsrevision, erbjuder detta ramverk[^4] ett nytt sätt att objektifiera ett ämne som har varit svårt att kvantifiera och jämföra.

Detta nya ramverk ligger i linje med den vitbok som branschinitiativet EuroStack publicerade bara veckor tidigare, med titeln ”*Ett föreslaget ramverk för en ”Buy European”-reglering av strategisk digital upphandling*”[^5].
...
{{< icon-block-horisontal
    ...
    color="#417DA5"
    text="Suveränitetspoäng"
    description="Safespring når <strong>86.25%</strong> enligt vår egen bedömning av EU:s Cloud Sovereignty Framework."
>}}
...
{{% timeline class="content-timeline--topics" ariaLabel="Safesprings suveränitetsbedömning" %}}
{{% timeline-item code="SOV-1" title="Strategisk suveränitet · Poäng 4" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-2" title="Juridisk och jurisdiktionell suveränitet · Poäng 4" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-3" title="Data- och AI‑suveränitet · Poäng 4" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-4" title="Operativ suveränitet · Poäng 4" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-5" title="Leveranskedjesuveränitet · Poäng 2" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-6" title="Teknisk suveränitet · Poäng 3" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-7" title="Säkerhets- och regelefterlevnadssuveränitet · Poäng 4" %}}
...
{{% /timeline-item %}}
{{% timeline-item code="SOV-8" title="Miljömässig hållbarhet · Poäng 4" %}}
...
## Referenser
[^1]:Trusted Cloud Referential av CIGREF och ANSSI:s Cloud de Confiance
[^2]:Souveräner Cloud
[^3]:Europeiska regelverk som ENISA, NIS2 och DORA.
[^4]:Europeiska kommissionens [Ramverk för molnsuveränitet](https://commission.europa.eu/document/09579818-64a6-4dd5-9577-446ab6219113_en)
[^5]:Eurostacks publikation, [*Ett föreslaget ramverk för en ”Buy European”-reglering av strategisk digital upphandling*](https://eurostack.eu/a-proposed-framework-for-buy-european-regulation/)
