...
aliases:
  ...
  - /tekniska-uppdateringar/2024-03-cinder-csi-volume-provisioner/
---
{{< ingress >}}
...
I `Chart.yaml`, uppdatera beroendena så att de söker efter samma version.
```yaml
dependencies:
...
I OpenStack kan du använda OpenStack CLI för att se din volym.
```bash
