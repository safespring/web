...
1. [Minnesoptimerad compute med GPU och lokal NVMe-disk](#4-compute-with-gpu-and-local-nvme-disk)
1. [Bare metal-beräkning](#5-bare-metal-compute)
...
## 2. Minnesoptimerad Compute {#2-memory-optimized-compute}
...
## 3. Grundläggande Compute med lokal NVMe-disk {#3-basic-compute-with-local-nvme-disk}
...
## 4. Compute med GPU och lokal NVMe-disk {#4-compute-with-gpu-and-local-nvme-disk}
...
## 5. Bare metal-beräkning {#5-bare-metal-compute}
