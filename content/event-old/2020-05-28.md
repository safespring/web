...
<div style="clear:both;padding:10px 0px 10px 0px;">
	<div class="safespring-event" data-styling="none">
		...
		<div class="desc">
			<p>
				<strong class="hed">Webinar 15 min</strong>
				<span class="des">Plattform: Zoom<br />Time: 10:00</span>
			</p>
		</div>
	</div>
	</div>
	...
	<div style="clear:both;padding:10px 0px 10px 0px;">
		<div class="safespring-event" data-styling="none">
			...
			<div class="desc">
				<p>
					<strong class="hed">Webinar 15 min</strong>
					<span class="des">Plattform: Zoom<br />Time: 10:15</span>
				</p>
			</div>
		</div>
		</div>
...
<a href="https://www.checkin.no/event/23288/den-digitale-digitaliseringskonferansen" id="button">Start påmeldingen</a>
